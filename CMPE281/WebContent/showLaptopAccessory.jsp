...
<jsp:useBean id="userBean" scope="session" class="com.cmpe281.project.beans.UserBean"></jsp:useBean>
	...
	<div align="center" >
		<p style="font: bold;font-size: x-large;"> LAPTOP ACCESSORIES </p>
	</div>
...
<div align="center" style="width: 40%;">
	<table border="1" align="center" width="100%" >
		...
		<tr>
			<td align="center">
				<c:out value="${laptopName}" />
			</td>
			<td align="center">
			<c:choose>
			<c:when test="${laptopAccessory.cover == 1}">
					 Cover/Case  <br>
				</c:when>
			</c:choose>
			<c:choose>
				<c:when test="${laptopAccessory.penDrive == 1}">
					 Pen Drive <br>
				</c:when>
			</c:choose>
			<c:choose>
				<c:when test="${laptopAccessory.hardDrive == 1}">
					 Hard Drive <br>
				</c:when>
			</c:choose>
			<c:choose>	
				<c:when test="${laptopAccessory.printer == 1}">
					 Printer <br>
				</c:when>
