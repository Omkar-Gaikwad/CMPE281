...
<jsp:useBean id="userBean" scope="session" class="com.cmpe281.project.beans.UserBean"></jsp:useBean>
   ...
   <div class="col-md-12">
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" align="center">
                                <div class="item active">
                                    <img class="slide-image"  style="max-height: 350px; max-width: 1100px;" src="http://thumbs.dreamstime.com/z/cricket-ball-bat-4535092.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" align="middle" style="max-height: 350px; max-width: 1100px;" src="http://www.artistsguidetogimp.com/wp-content/gallery/2-09-screening-type/2.9-01.ScreenOriginal.png" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" align="middle" style="max-height: 300px; max-width: 1000px;"  src="http://thumbs.dreamstime.com/x/badminton-racquet-shuttlecock-over-white-13726805.jpg" alt="">
                                </div>
                            </div>
	...
	<div align="center" >
		<p style="font: bold;font-size: x-large;">SPORTS</p>
	</div>
	...
	<div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <h4><a href="#" onclick="">${item.itemName}</a>                                		 
						 </a>
						  
                                </h4>
                                 <h4 >Brand <b>${item.brandName}</b></h4>
                                  <h4 >Sport <b>${item.sports}</b></h4>
